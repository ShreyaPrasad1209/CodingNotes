...
//BFS DFS in graph is same as tree just we need to add visited flag and check if it is not visited then add to queue in BFS
//This is because in graph cycles can form unlike trees
...
public:
    ...
    vector< vector<bool> > adjanceyMatrix;
